...
bin/gatk-4.2.0.0/gatk VariantFiltration \
    -R $REF_FAS \
...
vcftools \
	--vcf $RESULTS_DIR/filter_genotypes/merged_hardfilt.vcf \
	--minGQ 15 \
	--minDP 12 \
	--min-alleles 2 \
	--max-alleles 2 \
	...
	--recode-INFO-all \
	--stdout \
	>$RESULTS_DIR/filter_genotypes/merged_bisnps_min_gq_depth.vcf
